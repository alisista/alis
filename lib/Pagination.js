...
const _getByPageFromConf = R.compose(
  R.propSatisfies(R.isTrue, `by_page`),
  _propToGetAPI
)
...
const _cpParams = R.curryN(3, (conf, opts2 = {}, obj) =>
  R.compose(
    R.ifElse(
      R.always(_getByPageFromConf({ conf: conf })),
      R.compose(
        R.chain(
          R.assocPath([`opts`, `page`]),
          R.compose(
            R.inc,
